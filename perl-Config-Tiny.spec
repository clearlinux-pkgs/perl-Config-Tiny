...
Source0  : https://cpan.metacpan.org/authors/id/R/RS/RSAVAGE/Config-Tiny-2.27.tgz
...
%prep
%setup -q -n Config-Tiny-2.27
cd %{_builddir}/Config-Tiny-2.27
...
cp %{_builddir}/Config-Tiny-2.27/LICENSE %{buildroot}/usr/share/package-licenses/perl-Config-Tiny/c44f2a5783a554864280167f63754ee2b1b58be1
if test -f Makefile.PL; then
